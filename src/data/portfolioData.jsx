export const portfolioData = {
  hero: {
    ...
    valueStatement: "Building robust backend architectures, designing scalable REST APIs, and crafting intuitive user experiences with modern tech stacks.",
    cta1: "Download CV",
    cta2: "Contact Me"
  },
  about: {
  ...
  projects: [
    {
      ...
      description: "A multi-role logistics platform supporting Shipper, Carrier, and Customer workflows.",
    ...
    },
    {
      ...
      description: "A Decision Support System providing real-time crop recommendations based on environmental and soil parameters.",
