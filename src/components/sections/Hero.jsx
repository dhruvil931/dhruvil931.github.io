  ...
  return (
    <section className={styles.heroSection} id="home">
      <div className={`container ${styles.heroContainer}`}>
        ...
        <div className={`${styles.content} ${mounted ? styles.animateContent : ''}`}>
          ...
          <div className={styles.ctaGroup}>
            <a href="https://drive.google.com/file/d/1FMN0-DVzXP1iUbAXt0m8JO2c9vGr0kVm/view?usp=sharing" target="_blank" rel="noopener noreferrer" className={styles.primaryBtn}>{hero.cta1}</a>
            <a href="#contact" className={styles.secondaryBtn}>{hero.cta2}</a>
          </div>
        </div>
        
        {/* Right Side Visual Area (Abstract Glassmorphism) */}
        <div className={`${styles.visualArea} ${mounted ? styles.animateVisual : ''}`}>
          <div className={styles.abstractVisual}>
            ...
            <div className={`${styles.glassCard} ${styles.card2}`}>
              <div className={styles.cardIcon}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 22 8.5 22 15.5 12 22 2 15.5 2 8.5 12 2"></polygon></svg>
              </div>
              <div className={styles.cardText}>
